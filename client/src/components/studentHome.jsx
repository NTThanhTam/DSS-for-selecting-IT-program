...
const StudentHome = () => {
    ...
    return(
        <div>
            <NavBar />
            <header className='justify-center bg-homepageBgr bg-cover flex flex-col items-center h-[500px] dark:text-white text-center w-full relative bg-no-repeat z-0  overflow-hidden'>
                <div class="relative top-0 left-0 w-full h-full z-10 bg-black/70 flex items-center justify-center flex-col gap-5 ">
                    <h1 className='font-mono font-medium text-5xl max-w-4xl tracking-tight'>A Decision Support System for selecting <span className='font-bold text-[#F5E8C7]'>IT Programs</span></h1>
                </div>
            </header>
